...
В репозитории содержатся примеры популярных алгоритмов и структур данных на языке Typescript. Для каждого алгоритма и
...
Паттерны часто путают с алгоритмами, ведь оба понятия описывают типовые решения каких-то известных проблем. Но если алгоритм - это
чёткий набор действий, то паттерн - это высокоуровневое описание решения, реализация которого может отличаться в двух разных программах.
...
**Поведенческие паттерны** аботятся об эффективной коммуникации между объектами:
